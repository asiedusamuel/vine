<?php
	$controller->set('page-title', 'Ghana Projects');
	$controller->setBreadcrumbs("Home/Projects/Ghana");
							...
							<div class="row">
								<div class="col-md-4 p-5 mb-4 article-item wow fadeInRight animated"
									...
									<div class="article-image" style="background-image:
										url(./assets/images/adwoa.png);"></div>
									<div class="text center text-center">
										<h3><a href="./adwoa-kakraba-project/">Adwoa Kakraba Project</a></h3>
								...
								<div class="col-md-4 p-5 mb-4 article-item wow fadeInRight animated"
									...
									animation-name: fadeInRight;">
									<div class="article-image" style="background-image:
										url(./assets/images/orphanage.jpg);"></div>
									<div class="text center text-center">
										<h3 class="text-truncate"><a href="./orphanages-nasawam/">Orphanages, Nnasawam</a></h3>
								...
								<div class="col-md-4 p-5 mb-4 article-item wow fadeInRight animated"
									...
									<div class="text center text-center">
										<h3><a href="./ghana-prisons-ministry/">Ghana Prisons Ministry</a></h3>
